...
public class Camera {
    ...
    public static void updatePosition() {
        if (Keyboard.isKeyDown(Keyboard.KEY_W)) {
            position.setX(position.getX()-(float)(Math.sin(-rotation.getZ()*Math.PI/180)*speed));
            position.setY(position.getY()-(float)(Math.cos(-rotation.getZ()*Math.PI/180)*speed));
        }
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_A)) {
            position.setX(position.getX()+(float)(Math.sin((-rotation.getZ()-90)*Math.PI/180)*speed));
            position.setY(position.getY()+(float)(Math.cos((-rotation.getZ()-90)*Math.PI/180)*speed));
        }
